...
import pandas as pd
from functions.helper_functions import fix_column_names, fix_name_values, fix_date_values, fix_state_values
...
TRANSFORMATION_FUNCTIONS = {
    ...
    "fix_state_values": {
        ...
        "description": "Standardizes US state values in a column. Converts state codes to full names, full names to codes, or standardizes to proper case format using the US states dictionary.",
...
# Resolve data folder relative to this file so the app works regardless of cwd.
...
THEMES = {
    "Light": {
        ...
        "border": "#E0E0E0",  # Light gray borders (using light gray from monochromatic)
